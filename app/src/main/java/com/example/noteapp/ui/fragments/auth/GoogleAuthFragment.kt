...
import com.example.noteapp.databinding.FragmentGoogleAuthBinding
...
class GoogleAuthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.e("ololo", "onCreateView: start", )
    ...
    private fun updateUI(user: FirebaseUser?) {
        if (user != null){
            ...
            findNavController().navigate(R.id.action_googleAuthFragment_to_noteFragment)
        }else{
