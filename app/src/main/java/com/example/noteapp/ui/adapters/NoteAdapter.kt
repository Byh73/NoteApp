...
import com.example.noteapp.databinding.LinearNoteHolderBinding
import com.example.noteapp.ui.fragments.data.models.Note
import com.example.noteapp.ui.fragments.note.OnClickNote
import com.example.noteapp.utils.NoteDiffCallback

class NoteAdapter(var viewType: Int, private val onClickNote : OnClickNote) : ListAdapter<Note, RecyclerView.ViewHolder>(
    NoteDiffCallback() ) {
